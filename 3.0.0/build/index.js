...
kg/ks-timeline/3.0.0/toolbar
kg/ks-timeline/3.0.0/main-content
kg/ks-timeline/3.0.0/dd
kg/ks-timeline/3.0.0/config
kg/ks-timeline/3.0.0/control
kg/ks-timeline/3.0.0/index
...
KISSY.add('kg/ks-timeline/3.0.0/toolbar',function(S, Base){
  var $ = S.all;
...
KISSY.add('kg/ks-timeline/3.0.0/main-content',function(S, Base, TT, Anim){
  var $ = S.all;
...
/**
  * 普通元素拖拽
  */
KISSY.add('kg/ks-timeline/3.0.0/dd',function(S, Base){
  var $ = S.all, D = S.DOM;
 ...
 */
KISSY.add('kg/ks-timeline/3.0.0/config',function(S){
...
KISSY.add('kg/ks-timeline/3.0.0/control',function(S, Base, BG, Toolbar, MainContent, DD, TrackConfig){
  var $ = S.all;
...
KISSY.add('kg/ks-timeline/3.0.0/index',function(S, Control){
  var $ = S.all;
  //class
  /**
    * @param{config} 
